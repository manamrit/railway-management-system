         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item"><a class="nav-link text-light" href="#ticket">Book Now</a></li>
                  <li class="nav-item"><a class="nav-link text-light" href="#pass">Local Pass</a></li>
                  <li class="nav-item"><a class="nav-link text-light" href="transactions.php">Transactions</a></li>
                  <li class="nav-item"><a class="nav-link text-light" href="#feature">Features</a></li>
      ...
      <section class="banner-area jumbotron position-relative" id="home">
         ...
         <div class="container">
            <div class="banner-content position-relative d-flex flex-column align-items-center justify-content-center">
               ...
               <p class="text-white mt-3 mb-5">Quick Mumbai Local Train Booking</p>
            </div>
         </div>
      </section>
               ...
               <div class="convert-wrap p-5">
                  ...
                  <div class="row justify-content-center align-items-start">
                     ...
                     <div class="col-lg-4 text-white">
                        ...
                        <p>Class</p>
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="class" value="1">
                           <label class="form-check-label">First</label>
                        </div>
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="class" value="2" checked>
                           <label class="form-check-label">Second</label>
                        </div>
                        <div class="form-group mb-3 mt-2">
                           <input type="datetime-local" name="boarding_time" class="form-control" required>
                        </div>
                        <button class="btn btn-success btn-block my-5">Book Now</button>
                     </div>
                  </div>
               </div>
            </form>
               ...
               <div class="convert-wrap p-5">
                  ...
                  <div class="row justify-content-center align-items-start">
                     <div class="col-lg-4 text-white">
                        ...
                        <p>Class</p>
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="class" value="1" checked>
                           <label class="form-check-label">First</label>
                        </div>
                        <div class="form-check form-check-inline mb-3">
                           <input class="form-check-input" type="radio" name="class" value="2">
                           <label class="form-check-label">Second</label>
                        </div>
                        <div class="form-group">
                           <label for="via">Via</label>
                     ...
                     <div class="col-lg-4 text-white">
                        ...
                        <p>Duration</p>
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="duration" value="1" checked>
                           <label class="form-check-label">Monthly</label>
                        </div>
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="duration" value="2">
